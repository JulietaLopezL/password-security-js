...
Web app para generar contraseñas seguras según criterios seleccionados (longitud,
mayúsculas, números, símbolos). Proyecto enfocado en **JavaScript**, **HTML/CSS** y
...
# Cómo se usa?
Como desarrollador: clonar el repositorio y usar Live Server o abrir index.html en el
navegador.
